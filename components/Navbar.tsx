        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-6">
            {navLinks.map((link, index) => {
              const minWidths = ['70px', '80px', '80px', '80px'] // Home, Services, About, Contact
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-gray-700 hover:text-red-700 font-medium transition-colors duration-300 relative group whitespace-nowrap text-center inline-block"
